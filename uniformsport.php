...
//$e=$_SESSION['username'];
//$sup = $_POST["sup"];
$res = mysql_query("SELECT * from product_sports");
...
<div id="preloader"></div>
    ...
    <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/bg7.jpg);background-repeat: no-repeat;background-size: 100% 100%; padding: 30%;">
     ...
     <div class="display-tc animate-box" data-animate-effect="fadeIn" align="center" style="padding-top: 0%;padding-bottom: 3%;margin-top: 0%; ">
         <h1 style="padding-top: 3%; color: #121244">Uniforms of Sports</h1>						
	</div>
